...
var editAsistenciaFromUsuario = exports.asistenciaIdPlenoAsociadosIdAsociadoPUT = function(body, idPleno, idAsociado) {
  return new Promise(function(resolve, reject) {
    ...
    extraService.special(
      `
      UPDATE u438573835_censo.ffsj_plenos_asistencia SET idAsociado = '${body.idAsociado}', delegado = ${body.delegado}, asistenciaConfirmada = ${body.asistenciaConfirmada}, asistenciaConfirmadaPorSecretaria = ${body.asistenciaConfirmadaPorSecretaria} WHERE (idPleno = '${idPleno}') and (idAsistencia = '${body.idAsistencia}');
      `
    ).then(res => {
